...
describe('conversion', () => {
    ...
    it('should convert 2-question GIFT to LaTeX', () => {
        expect(convertQuizToLaTeX(quiz, "1", false, false, false)).toEqual(
    ...
    it('should convert 2-question GIFT to LyX', () => {
        expect(convertQuizToLaTeX(quiz, "1", false, true, false)).toEqual(
            ['% LaTeX generated by gift2latex (npm package)',
                '\\begin{myquestions}',
                '\\myquestion[1]',
                'What is 2 + 2',
    ...
    it('should convert 2-question GIFT to LaTeX with \\half points', () => {
        expect(convertQuizToLaTeX(quiz, "\\half", false, false, false)).toEqual(
            ['% LaTeX generated by gift2latex (npm package)',
                '\\begin{questions}',
                '\\question[\\half]',
                'What is 2 + 2',
    ...
    it('should convert 1-question GIFT in Markdown to LaTeX with markdown package', () => {
        expect(convertQuizToLaTeX(markdownQuiz, "1", false, false, true)).toEqual(
            ['% LaTeX generated by gift2latex (npm package)',
                '\\begin{questions}',
                '\\question[1]',
                '\\begin{markdown}',
    ...
    it('should convert 1-question GIFT in Markdown with Codefence to LaTeX with markdown package', () => {
        expect(convertQuizToLaTeX(markdownCodeFenceQuiz, "1", false, false, true).replace(/\r/g, '')).toEqual(`% LaTeX generated by gift2latex (npm package)
\\begin{questions}
\\question[1]
\\begin{markdown}
A:
